...
public class PFCodeView extends LinearLayout {
    ...
    List<ImageView> mCodeViews = new ArrayList<>();
    ...
    private void setUpCodeViews() {
        ...
        for (int i = 0; i < mCodeLength; i++) {
            ...
            ImageView view = (ImageView) (inflater != null ? inflater.inflate(R.layout.view_pf_code_checkbox, null) : null);
            ...
            view.setImageResource(R.drawable.ic_not_checked_dot);
            addView(view);
            mCodeViews.add(view);
        }
        if (mListener != null) {
    ...
    public int input(String number) {
        ...
        mCodeViews.get(mCode.length()).setImageResource(R.drawable.ic_checked_dot); //.setChecked(true);
        mCode += number;
    ...
    public int delete() {
        ...
        mCodeViews.get(mCode.length()).setImageResource(R.drawable.ic_not_checked_dot);  //.setChecked(false);
        return mCode.length();
    }
    ...
    public void clearCode() {
        ...
        mCode = "";
        for (ImageView codeView : mCodeViews) {
            codeView.setImageResource(R.drawable.ic_not_checked_dot);
        }
    }
